export const listDataKeahlian = [
    {
        ...
        content_en: `Hypertext Preprocessor or PHP is an open-source scripting language that is widely used in programming or web development. It generally runs in server-side communication, and is currently supported by almost all systems.`,
    ...
    },
    {
        ...
        content_en: `.NET is a free, cross-platform, open-source developer platform for building various types of applications. It can run programs written in several languages, with C# being the most popular. It relies on a high-performance runtime that is used in production by many high-scale applications.`,
    ...
    {
        img: "https://cyberhoot.com/wp-content/uploads/2020/07/Free-Courses-to-learn-JavaScript.jpg",
        title: "JavaScript",
        ...
        content_en: `JavaScript.com is a resource built by the Pluralsight team for the JavaScript community. Since JavaScript is a great language for beginner coders, we have collected some of the best learning resources and created JavaScript courses to help developers get up and running.`,
        link: "https://www.javascript.com/"
    },
    {
        img: "https://tkj.smkdarmasiswasidoarjo.sch.id/wp-content/uploads/2024/10/laravel.jpg",
        title: "Laravel",
        ...
        content_en: `Laravel is a web application framework with an expressive and elegant syntax. Web frameworks provide a structure and starting point for building your application, allowing you to focus on creating something amazing while we figure out the details.`,
        link: "https://laravel.com/"
    },
    {
        ...
        content_en: `CodeIgniter is an Application Development Framework building websites using PHP. Its goal is to enable developing projects faster than you could if you were writing code from scratch, by providing a set of libraries for commonly needed tasks.`,
    ...
    },
    {
        ...
        content_en: `Vue (pronounced /vjuː/, like view) is a JavaScript framework for building user interfaces. The framework is built on standard HTML, CSS, and JavaScript and provides a declarative component-based programming model that helps you develop user interfaces of any complexity efficiently.`,
    ...
    },
    {
        ...
        content_en: `Tailwind CSS works by scanning all HTML files, JavaScript components, and any other templates for class names, generating appropriate styles, and then writing them to a static CSS file.`,
    ...
    },
    {
        ...
        content_en: `CSS is one of the technical terms in programming. Although often considered a programming language, CSS is not part of it. Tech Terms says, CSS is a styling language (design language), part of a markup language that can “color” or design a web page.`,
    ...
    },
    {
        ...
        content_en: `Adobe Illustrator is a software application quite popular among professionals, business design, and the art world that is used by graphic designers to create vector graphics. This vector graphics editor program-based application is developed and marketed by Adobe Systems. Adobe began developing Illustrator in 1985.`,
    ...
    },
    {
        ...
        content_en: `CorelDRAW is a graphics processing software that has the utility to help designers' work. This software was developed by Corel Corporation, a company based in Ottawa, Canada. Quoted from its official website, Corel helps more than 90 million workers to be more creative and productive through their products.`,
...
export const listDataProject = [
    ...
    },
    {
        ...
        content_en: `This application is a project of PLN Icon Plus. This is an outsourced project, I was assigned the back-end part of this dashboard display. This project is done remotely and onsite team once a week to the PLN Social Security Office. This project was created using the .Net Core 4 framework and React JS.`,
    ...
    },
    {
        ...
        title_en: `Employee Appraisal App`,
        title: "Aplikasi Penilaian Karyawan",
        content_en: `This application is a project of the company Pajar Mas Murni. In this project, we were assigned to create this application from scratch as a team. This application is used to conduct assessments to employees online. This project was created using the CodeIgniter 4 framework and Bootstrap 5.`,
    ...
    },
    {
        ...
        title_en: `Student Internship App`,
        title: "Aplikasi Magang Siswa",
        content_en: `This application is a project of the Toyota Astra Motor company. This project was assigned to create an application from scratch and was carried out in teams. This application is used for data collection of schools, students and dealers who will do internships to TAM companies. This project was created using the .Net Core 8 framework and Bootstrap 5.`,
    ...
    },
    {
        ...
        title_en: `Study Guidance App`,
        title: "Aplikasi Bimbingan Belajar",
        content_en: `This application is used to record online tutoring participants and online payment data at Brilliant Learning Center tutoring. This application was created using the Laravel 8 framework and Bootstrap 5.`,
    ...
    },
    {
        ...
        title_en: `Fabric Inventory App`,
        title: "Aplikasi Inventory Kain",
        content_en: `This application is used to record fabric inventory, especially those that have been sold and fabric data purchased online. This application was created using the Laravel 8 framework and Bootstrap 5.`,
    ...
    },
    {
        ...
        title_en: `Practicum Acheduling App`,
        title: "Aplikasi Penjadwalan Praktikum",
        content_en: `This application can avoid inputting conflicting schedules and if the inputted schedule clashes, a notification will appear and recommendations for schedules that will not clash. This application was created using the CodeIgniter 3 framework and Bootstrap 3.`,
    ...
    },
    {
        ...
        title_en: `Profile and Registration PAUD Mawarsari 6 App`,
        title: "Aplikasi profil dan pendaftaran PAUD Mawarsari 6",
        content_en: `This application contains the data of Mawarsari PAUD and publishes it to the proper thing and can register online. This application was created using CodeIgniter 3 framework and Bootstrap 4.`,
    ...
    },
    {
        ...
        title_en: `Profile Scouts Kwaran Ibun App`,
...
export const dataListPengalaman = [
    ...
    },
    {
        ...
        content_en: `In this company I am a Staff Web Programmer (2024). Here I work with a team and work on fullstack beck-end tasks with PHP or .Net programming language frameworks. On the front-end mostly using VueJS. My work implementation is with the team and there are also Out sourching projects.`,
    ...
    },
    {
        ...
        title_en: `PT. Arkamaya`,
        title: "PT. Arkamaya",
        content_en: `In this company I am a Staff Web Programmer (2023-2024). Here I work with a team and work on fullstack beck-end tasks with PHP or .Net programming language frameworks. In the front-end part, most of them use templates and jquery. There are also front-end parts using Vue JS only adding additional features and changes.`,
    ...
    },
    {
        ...
        title_en: `HmI Komisariat UNIBBA`,
        title: "HmI Komisariat UNIBBA",
        content_en: `In the HmI Organization I served as General Secretary for the period (2020-2022). Here I apply a lot of computer science that I master such as correspondence, data collection, graphic design and so on. Of course, in HmI I learned a lot about working together with other field administrators to achieve common goals.`,
    ...
    },
    {
        ...
        title_en: `Bandung Regency Esport Tournament`,
        title: "Turnamen Esport Kabupaten Bandung",
        content_en: `In this activity I acted as a committee secretary who made the letters needed for activities, design drawings and so on. In this activity we worked together compactly to complete the preparation until the day of the implementation took place and carried out the tournament activities as well as possible.`,
    ...
    },
    {
        ...
        title_en: `BPPTIK Offline Training`,
        title: "Pelatihan BPPTIK Offline",
        content_en: `In the science that I took in this training is Junior Office Operator. This activity starts from the training stage to certification testing. In this training, I learned a lot about Microsoft Word, Excel, Powerpoint and the use of the internet. At the time of testing, I passed and received BNSP certification.`,
    ...
    },
    {
        ...
        title_en: `BPPTIK Online Training`,
        title: "Pelatihan BPPTIK online",
        content_en: `In the science that I took in this training is Junior Web Developer. This activity starts from the training stage to certification testing. In this training, I learned about creating web interfaces using HTML and CSS. The display is combined with the PHP programming language and MySQL database. I even used the Bootstrap and JQuery frameworks. At the testing stage I passed and received BNSP certification.`,
...
export const listDataPendidikan = [
    {
    ...
    },
    {
        ...
        title_en: "SMK Integrated Islamic Talegong",
        ...
        content_en: `At the high school level, I studied at SMK Islam Terpadu Talegong with a major in Office Administration. Here I learned a lot about using Microsoft Office software used in offices. I learned a lot about organizing or managing the storage of office items or working time.`,
        link: "https://sekolah.data.kemdikbud.go.id/index.php/chome/profil/3250513f-5e0b-4945-9f10-140769b32e62"
    }
];

export const listDataSosmed = [
    {
        content_en: ``,
